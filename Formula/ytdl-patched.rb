class YtdlPatched < Formula
  ...
  url "https://github.com/ytdl-patched/ytdl-patched/releases/download/2023.02.10.1676041575/yt_dlp-wheel.tar.gz" # replace-marker
  version "2023.02.10.1676041575" # replace-marker
  sha256 "50ac0f4d5b58c8c0c65d4fb6aa309599506fd103cd0d0e3a1393338165cbff7a" # replace-marker
  license "Unlicense"
