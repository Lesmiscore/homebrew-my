class YtdlPatched < Formula
  ...
  url "https://github.com/ytdl-patched/ytdl-patched/releases/download/2023.05.28.1685234459/ytdl_patched-wheel.tar.gz" # replace-marker
  version "2023.05.28.1685234459" # replace-marker
  sha256 "7c90503030087946d3a8b121adbc3137a7c0eaadeb8dff9a507242b6e2d35d68" # replace-marker
  license "Unlicense"
