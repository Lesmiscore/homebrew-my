class YtdlPatched < Formula
  ...
  url "https://github.com/ytdl-patched/ytdl-patched/releases/download/2023.03.17.1679013592/yt_dlp-wheel.tar.gz" # replace-marker
  version "2023.03.17.1679013592" # replace-marker
  sha256 "18f13281fcd296309bbc4ad034814673eb8ecdadb5e8ed52521a34d077cd231a" # replace-marker
  license "Unlicense"
