class YtdlPatched < Formula
  ...
  url "https://github.com/ytdl-patched/ytdl-patched/releases/download/1638929234/yt_dlp-wheel.tar.gz" # replace-marker
  version "1638929234" # replace-marker
  sha256 "da2e5169f6c5fc345ca6b4e1f6a70094bfc13ad3769223935fba1eb7573ff73a" # replace-marker
  license "Unlicense"
