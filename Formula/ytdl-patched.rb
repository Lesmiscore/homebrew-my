class YtdlPatched < Formula
  ...
  url "https://github.com/ytdl-patched/ytdl-patched/releases/download/2023.02.12.1676182177/yt_dlp-wheel.tar.gz" # replace-marker
  version "2023.02.12.1676182177" # replace-marker
  sha256 "c42fc2d0501d34320afc66c18463a1c100424007d7fd063ff90606631e237f93" # replace-marker
  license "Unlicense"
