class YtdlPatched < Formula
  ...
  url "https://github.com/ytdl-patched/ytdl-patched/releases/download/1638353459/yt_dlp-wheel.tar.gz" # replace-marker
  version "1638353459" # replace-marker
  sha256 "05cabbc74f01ea83fdd753b5e39c5f5f0a6ef998012fbce79719c852b65259cd" # replace-marker
  license "Unlicense"
